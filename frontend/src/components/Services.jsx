...
const Services = () => {
  const services = [
    {
      title: 'AI Legal Chat',
      desc: 'Ask anything about Indian law. Get instant answers grounded in statutes and judgments in any Indian language.',
      icon: (
    ...
    },
    {
      ...
      desc: 'Upload contracts, notices, or case files. NyayAI provides instant analysis and OCR processing.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Live Case Research',
      desc: 'Real-time search across Supreme Court, High Courts, and latest legal notifications with citations.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Precision OCR & Voice',
      desc: 'Handwritten or scanned—our neural vision extracts data with 99.9% accuracy. Built-in voice support.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
