                  ...
                  {chats.map((chat) => (
                    ...
                    >
                      ...
                      <button 
                        ...
                        className="absolute right-2 bottom-2 opacity-0 group-hover:opacity-100 p-2 text-gray-500 hover:text-red-500 hover:bg-white/10 rounded-lg transition-all z-20"
                        title="Delete Chat"
                      >
