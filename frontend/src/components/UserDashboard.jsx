      ...
      case 'support':
        return (
          <div className="animate-fade-in max-w-4xl">
            <h2 className="text-3xl font-bold font-display mb-8">Admin Support</h2>
            <div className="glass-card flex flex-col items-center justify-center py-20 border-dashed border-2 border-white/10 opacity-50">
               <svg className="w-16 h-16 text-gray-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
               <p className="text-gray-500 font-bold uppercase tracking-widest">Support System Initializing...</p>
               <p className="text-gray-600 text-xs mt-2">Will be active once the Admin Dashboard is configured.</p>
            </div>
          </div>
        );
      case 'account':
